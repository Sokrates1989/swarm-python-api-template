...
if [ "$STACK_FAMILY" = "nginx" ]; then
    REQUIRED_KEYS=("STACK_NAME" "IMAGE_NAME" "IMAGE_VERSION" "PROXY_TYPE" "PORT" "DATA_ROOT")
else
    REQUIRED_KEYS=("STACK_NAME" "IMAGE_NAME" "IMAGE_VERSION" "DB_TYPE" "DB_MODE" "PROXY_TYPE" "DATA_ROOT")
fi
