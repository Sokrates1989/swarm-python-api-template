...
# ------------------------------------------------------------------------------
# Batch secret-file import module
# ------------------------------------------------------------------------------
# Keep plaintext parsing, validation, signal cleanup, and editor orchestration
# in a focused module while preserving the historical public function names.
_secret_file_import_module="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)/secret-file-import.sh"
# shellcheck disable=SC1090
source "$_secret_file_import_module"
unset _secret_file_import_module
# ------------------------------------------------------------------------------
