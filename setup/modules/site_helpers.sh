...
_load_keycloak_profile_defaults() {
    ...
    APP_KEYCLOAK_LOGIN_THEME="$(_jq_or_default "$config_file" '.auth.themes.login' "default")"
    APP_KEYCLOAK_ACCOUNT_THEME="$(_jq_or_default "$config_file" '.auth.themes.account' "default")"
    APP_KEYCLOAK_ADMIN_THEME="$(_jq_or_default "$config_file" '.auth.themes.admin' "default")"
    APP_KEYCLOAK_EMAIL_THEME="$(_jq_or_default "$config_file" '.auth.themes.email' "default")"
    APP_KEYCLOAK_INTERNATIONALIZATION_ENABLED="$(_jq_or_default "$config_file" '.auth.localization.enabled' "false")"
    APP_KEYCLOAK_SUPPORTED_LOCALES="$(jq -r '.auth.localization.supportedLocales // [] | join(",")' "$config_file")"
    APP_KEYCLOAK_DEFAULT_LOCALE="$(_jq_or_default "$config_file" '.auth.localization.defaultLocale' "en")"
    APP_KEYCLOAK_EMAIL_SENDER_ENABLED="$(_jq_or_default "$config_file" '.auth.emailSender.enabled' "false")"
    APP_KEYCLOAK_SMTP_FROM="$(_jq_or_default "$config_file" '.auth.emailSender.from' "")"
    APP_KEYCLOAK_SMTP_FROM_DISPLAY_NAME="$(_jq_or_default "$config_file" '.auth.emailSender.fromDisplayName' "")"
    APP_KEYCLOAK_SMTP_REPLY_TO="$(_jq_or_default "$config_file" '.auth.emailSender.replyTo' "")"
    APP_KEYCLOAK_SMTP_REPLY_TO_DISPLAY_NAME="$(_jq_or_default "$config_file" '.auth.emailSender.replyToDisplayName' "")"
    APP_KEYCLOAK_SMTP_ENVELOPE_FROM="$(_jq_or_default "$config_file" '.auth.emailSender.envelopeFrom' "")"
    APP_KEYCLOAK_SMTP_HOST="$(_jq_or_default "$config_file" '.auth.emailSender.host' "")"
    APP_KEYCLOAK_SMTP_PORT="$(_jq_or_default "$config_file" '.auth.emailSender.port' "587")"
    APP_KEYCLOAK_SMTP_STARTTLS="$(_jq_or_default "$config_file" '.auth.emailSender.startTls' "true")"
    APP_KEYCLOAK_SMTP_SSL="$(_jq_or_default "$config_file" '.auth.emailSender.ssl' "false")"
    APP_KEYCLOAK_SMTP_AUTH="$(_jq_or_default "$config_file" '.auth.emailSender.authentication' "true")"
    APP_KEYCLOAK_SMTP_USERNAME="$(_jq_or_default "$config_file" '.auth.emailSender.username' "")"
...
_load_executable_keycloak_env_fields() {
    ...
    export KEYCLOAK_LOGIN_THEME="$(_root_env_value "$env_file" KEYCLOAK_LOGIN_THEME)"
    export KEYCLOAK_ACCOUNT_THEME="$(_root_env_value "$env_file" KEYCLOAK_ACCOUNT_THEME)"
    export KEYCLOAK_ADMIN_THEME="$(_root_env_value "$env_file" KEYCLOAK_ADMIN_THEME)"
    export KEYCLOAK_EMAIL_THEME="$(_root_env_value "$env_file" KEYCLOAK_EMAIL_THEME)"
    export KEYCLOAK_INTERNATIONALIZATION_ENABLED="$(_root_env_value "$env_file" KEYCLOAK_INTERNATIONALIZATION_ENABLED)"
    export KEYCLOAK_SUPPORTED_LOCALES="$(_root_env_value "$env_file" KEYCLOAK_SUPPORTED_LOCALES)"
    export KEYCLOAK_DEFAULT_LOCALE="$(_root_env_value "$env_file" KEYCLOAK_DEFAULT_LOCALE)"
    export KEYCLOAK_EMAIL_SENDER_ENABLED="$(_root_env_value "$env_file" KEYCLOAK_EMAIL_SENDER_ENABLED)"
    export KEYCLOAK_SMTP_FROM="$(_root_env_value "$env_file" KEYCLOAK_SMTP_FROM)"
    export KEYCLOAK_SMTP_FROM_DISPLAY_NAME="$(_root_env_value "$env_file" KEYCLOAK_SMTP_FROM_DISPLAY_NAME)"
    export KEYCLOAK_SMTP_REPLY_TO="$(_root_env_value "$env_file" KEYCLOAK_SMTP_REPLY_TO)"
    export KEYCLOAK_SMTP_REPLY_TO_DISPLAY_NAME="$(_root_env_value "$env_file" KEYCLOAK_SMTP_REPLY_TO_DISPLAY_NAME)"
    export KEYCLOAK_SMTP_ENVELOPE_FROM="$(_root_env_value "$env_file" KEYCLOAK_SMTP_ENVELOPE_FROM)"
    export KEYCLOAK_SMTP_HOST="$(_root_env_value "$env_file" KEYCLOAK_SMTP_HOST)"
    export KEYCLOAK_SMTP_PORT="$(_root_env_value "$env_file" KEYCLOAK_SMTP_PORT)"
    export KEYCLOAK_SMTP_STARTTLS="$(_root_env_value "$env_file" KEYCLOAK_SMTP_STARTTLS)"
    export KEYCLOAK_SMTP_SSL="$(_root_env_value "$env_file" KEYCLOAK_SMTP_SSL)"
