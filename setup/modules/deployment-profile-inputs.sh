...
_derive_keycloak_deployment_values() {
    ...
    KEYCLOAK_LOGIN_THEME="$(_deployment_existing_value KEYCLOAK_LOGIN_THEME "${APP_KEYCLOAK_LOGIN_THEME:-default}")"
    KEYCLOAK_ACCOUNT_THEME="$(_deployment_existing_value KEYCLOAK_ACCOUNT_THEME "${APP_KEYCLOAK_ACCOUNT_THEME:-default}")"
    KEYCLOAK_ADMIN_THEME="$(_deployment_existing_value KEYCLOAK_ADMIN_THEME "${APP_KEYCLOAK_ADMIN_THEME:-default}")"
    KEYCLOAK_EMAIL_THEME="$(_deployment_existing_value KEYCLOAK_EMAIL_THEME "${APP_KEYCLOAK_EMAIL_THEME:-default}")"
    KEYCLOAK_INTERNATIONALIZATION_ENABLED="$(_deployment_existing_value KEYCLOAK_INTERNATIONALIZATION_ENABLED "${APP_KEYCLOAK_INTERNATIONALIZATION_ENABLED:-false}")"
    KEYCLOAK_SUPPORTED_LOCALES="$(_deployment_existing_value KEYCLOAK_SUPPORTED_LOCALES "${APP_KEYCLOAK_SUPPORTED_LOCALES:-}")"
    KEYCLOAK_DEFAULT_LOCALE="$(_deployment_existing_value KEYCLOAK_DEFAULT_LOCALE "${APP_KEYCLOAK_DEFAULT_LOCALE:-en}")"
    KEYCLOAK_EMAIL_SENDER_ENABLED="$(_deployment_existing_value KEYCLOAK_EMAIL_SENDER_ENABLED "${APP_KEYCLOAK_EMAIL_SENDER_ENABLED:-false}")"
    KEYCLOAK_SMTP_FROM="$(_deployment_existing_value KEYCLOAK_SMTP_FROM "${APP_KEYCLOAK_SMTP_FROM:-}")"
    KEYCLOAK_SMTP_FROM_DISPLAY_NAME="$(_deployment_existing_value KEYCLOAK_SMTP_FROM_DISPLAY_NAME "${APP_KEYCLOAK_SMTP_FROM_DISPLAY_NAME:-}")"
    KEYCLOAK_SMTP_REPLY_TO="$(_deployment_existing_value KEYCLOAK_SMTP_REPLY_TO "${APP_KEYCLOAK_SMTP_REPLY_TO:-}")"
    KEYCLOAK_SMTP_REPLY_TO_DISPLAY_NAME="$(_deployment_existing_value KEYCLOAK_SMTP_REPLY_TO_DISPLAY_NAME "${APP_KEYCLOAK_SMTP_REPLY_TO_DISPLAY_NAME:-}")"
    KEYCLOAK_SMTP_ENVELOPE_FROM="$(_deployment_existing_value KEYCLOAK_SMTP_ENVELOPE_FROM "${APP_KEYCLOAK_SMTP_ENVELOPE_FROM:-}")"
    KEYCLOAK_SMTP_HOST="$(_deployment_existing_value KEYCLOAK_SMTP_HOST "${APP_KEYCLOAK_SMTP_HOST:-}")"
    KEYCLOAK_SMTP_PORT="$(_deployment_existing_value KEYCLOAK_SMTP_PORT "${APP_KEYCLOAK_SMTP_PORT:-587}")"
    KEYCLOAK_SMTP_STARTTLS="$(_deployment_existing_value KEYCLOAK_SMTP_STARTTLS "${APP_KEYCLOAK_SMTP_STARTTLS:-true}")"
    KEYCLOAK_SMTP_SSL="$(_deployment_existing_value KEYCLOAK_SMTP_SSL "${APP_KEYCLOAK_SMTP_SSL:-false}")"
    KEYCLOAK_SMTP_AUTH="$(_deployment_existing_value KEYCLOAK_SMTP_AUTH "${APP_KEYCLOAK_SMTP_AUTH:-true}")"
    KEYCLOAK_SMTP_USERNAME="$(_deployment_existing_value KEYCLOAK_SMTP_USERNAME "${APP_KEYCLOAK_SMTP_USERNAME:-}")"
    ...
    KEYCLOAK_BOOTSTRAP_USERS_CLEANUP_PENDING="$(_deployment_existing_value KEYCLOAK_BOOTSTRAP_USERS_CLEANUP_PENDING "false")"
    KEYCLOAK_BOOTSTRAP_USERS_CLEANUP_NAMES="$(_deployment_existing_value KEYCLOAK_BOOTSTRAP_USERS_CLEANUP_NAMES "")"
    ...
    export KEYCLOAK_LOGIN_THEME KEYCLOAK_ACCOUNT_THEME
    export KEYCLOAK_ADMIN_THEME KEYCLOAK_EMAIL_THEME
    export KEYCLOAK_INTERNATIONALIZATION_ENABLED KEYCLOAK_SUPPORTED_LOCALES
    export KEYCLOAK_DEFAULT_LOCALE KEYCLOAK_EMAIL_SENDER_ENABLED
    export KEYCLOAK_SMTP_FROM KEYCLOAK_SMTP_FROM_DISPLAY_NAME
    export KEYCLOAK_SMTP_REPLY_TO KEYCLOAK_SMTP_REPLY_TO_DISPLAY_NAME
    export KEYCLOAK_SMTP_ENVELOPE_FROM KEYCLOAK_SMTP_HOST
    export KEYCLOAK_SMTP_PORT KEYCLOAK_SMTP_STARTTLS KEYCLOAK_SMTP_SSL
    export KEYCLOAK_SMTP_AUTH KEYCLOAK_SMTP_USERNAME
    export KEYCLOAK_BOOTSTRAP_TEST_USERS_ENABLED
    export KEYCLOAK_BOOTSTRAP_USERS_CLEANUP_PENDING
    export KEYCLOAK_BOOTSTRAP_USERS_CLEANUP_NAMES KEYCLOAK_AUDIENCE
...
_initialize_default_service_values() {
    ...
    POSTGRES_IMAGE="${APP_DB_IMAGE:-}"
    REDIS_IMAGE="${APP_REDIS_IMAGE:-}"
    PGADMIN_IMAGE="${APP_PGADMIN_IMAGE:-}"
...
load_deployment_configuration_from_env() {
    ...
    POSTGRES_IMAGE="${POSTGRES_IMAGE:-$APP_DB_IMAGE}"
    REDIS_IMAGE="${REDIS_IMAGE:-$APP_REDIS_IMAGE}"
    PGADMIN_IMAGE="${PGADMIN_IMAGE:-$APP_PGADMIN_IMAGE}"
